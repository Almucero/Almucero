...
Residente en Málaga, España, soy un estudiante de desarrollo de software que actualmente cursa su segundo año de **Desarrollo de Aplicaciones Multiplataforma (DAM)** en el **CPIFP Alan Turing** (PTA). Me caracterizo por ser un profesional creativo, organizado y detallista, con un fuerte interés en la **Inteligencia Artificial** y la **Arquitectura de Software**.
...
*2024 - Presente (Finalización prevista en 2025)*
...
* **Inglés:** Competencia profesional completa (**C1 Advanced Cambridge**)
* *Francés y Japonés:* Competencia elemental

**Certificaciones**

* **Certificate in Advanced English (C1)** - Cambridge Assessment English
* **Curso de MongoDB**
...
* **LinkedIn:** [linkedin.com/in/almucero](https://www.linkedin.com/in/almucero)
* **Email:** alvarokilor@gmail.com
